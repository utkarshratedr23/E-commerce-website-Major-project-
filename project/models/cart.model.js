//this dont uses database as we dont want user to access cart only when he is logged in. 
...
class Cart{
    ...
    for(let i=0;i<this.items.length;i++){
        ...
        if(item.product.id=== product.id){
            ...
            this.items[i]=cartItem;/* Gets updated with cartitem*/
        ...
        this.items.push(cartItem);/*pushing items in product*/
        this.totalQuantity++;
        this.totalPrice+= product.price;
    }
